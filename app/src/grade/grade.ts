...
const SYSTEM_PROMPT = [
  ...
  "(the bias call vs the realized window). The marked levels are a discipline ritual and are NOT",
  "scored — use them as context for whether trades leaned on planned prices, not as a graded drill.",
  "",
  ...
  "The digest also carries `intradayLevels`: the objective auto-computed Opening-Range and Initial-",
  "Balance catalog (edges, retracements, extensions) and the final NY-open VWAP. These are context",
  "the trader had on the chart — reference them when judging entries/exits (e.g. a fade at the IB edge,",
  "a target at VWAP), but they are NOT scored and you must not grade the trader for 'marking' them.",
